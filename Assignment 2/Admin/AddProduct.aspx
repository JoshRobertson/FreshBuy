<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdminMenu.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Assignment_2.Admin.AddProduct" Theme="General" UnobtrusiveValidationMode="None" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <hr />
                <asp:Button runat="server" ID="addProductButton" OnClick="CreateProduct" Text="Submit" CausesValidation="True" SkinID="buttonSkin" />
            </div>
        </div>
    </div>
</asp:Content>
